...
Common issues:
- If the repo link in bot's response is very long and starts with `https://can01.safelinks...` that's OK, it's a protection mechanism used by Outlook, this link will automatically redirect to the actual GitHub repo URL.
- If you see a 404 error (not found) it's probably because you are not logged into GitHub in your browser. Log in to GitHub and click the link again.
